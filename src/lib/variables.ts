...
export const LINKEDIN_URL = import.meta.env.VITE_PUBLIC_LINKEDIN_URL as string
export const GOOGLE_MEASUREMENT_ID = import.meta.env
  .VITE_PUBLIC_GOOGLE_MEASUREMENT_ID as string
