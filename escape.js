...
/**
 * Via: https://github.com/tamino-martinius/node-ts-dedent (by Tamino Martinius)
 * @license MIT
 */
 ...
 */
export const wrap = (tag, content, filename, highlight, format) => {
...
const process = (opts) => {
  ...
  return {
    markup: async ({ content, filename }) => {
      ...
      return wrap(opts.tag, content, filename, opts.highlighter, opts.formatter)
    }
  }
}
